...
<div class="content" style="background: #fff;width: 50%;margin: 50px auto;padding: 50px;">
    ...
    <div class="body">
        <p>Hi {{$name}} <br>We received a request to reset your {{config('app.name')}} password,enter the following password reset code</p>
        <p>The code is {{url('/register/forget/'.$hash)}}</p></div>
    <!-- END BODY -->
