                ...
                <div class="col-12  col-sm-12 col-md-5 col-lg-5 mt-2 invoice">
                    ...
                    <div class="col-12">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in order" :key="index" @mouseover="show_input = index" @mouseout="show_input = false">
                       ...
                       <button class="btn btn-md btn-primary bt-5" @click="MAKE_PAYMENT">Sell</button>
                    </div>
...
<script>
    ...
    export default {
        ...
        computed: mapState({
            ...
            invoice_number: state => state.customers.invoice_number,
        }),
        ...
        methods: {
            ...
            MAKE_PAYMENT() {
              this.$store.dispatch('CREATE_NEW_CUSTOMER_PAYMENT', {id: this.$route.params.id ,order:this.order, total_price:this.total_price});
            }
        }
