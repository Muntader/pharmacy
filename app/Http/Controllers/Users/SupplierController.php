...
class SupplierController extends Controller
{
   /*
     ...
     * **********************************/
     ...
     public function get(){
         $getSuppliers = DB::table('suppliers')->where('uid',Auth::id())->get();
     ...
     * **********************************/
     ...
     public function update(Request $request){
            ...
            $check = Supplier::where('id', $request->input('id'))->where('uid', Auth::id())->first();
     ...
     * **********************************/
     ...
     public function delete($id){
            ...
            $check = Supplier::where('id',$id)->where('uid', Auth::id())->first();
