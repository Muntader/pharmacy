...
class CategoriesController extends Controller
{
     ...
     * **********************************/
     ...
     public function get(){
        ...
        $getCategories = DB::table('categories')->where('uid',Auth::user()->pharmacy_id)->get();
     ...
     * **********************************/
     ...
     public function delete($id){
            ...
            $check = Categorie::where('id',$id)->where('uid', Auth::user()->pharmacy_id)->first();
     ...
     * **********************************/
     ...
     public function update(Request $request){
            ...
            $check = Categorie::where('id', $request->input('id'))->where('uid', Auth::user()->pharmacy_id)->first();
